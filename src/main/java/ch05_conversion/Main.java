...
public class Main {
    public static void main(String[] args) {
        // 1. Up Casting(업캐스팅) : 더 큰 용량의 자료형으로 변환시키는 것
        System.out.println("---업캐스팅---");
        System.out.println("---업캐스팅 # 1---");
        char cast1 = 'A';
        ...
        System.out.println("변형 : " + (int)cast2);   // 소문자의 경우는 대문자만큼은 출제 되지 않지만
                                                     // 외워야 할 필요는 있음

        // 업캐스팅 방법 # 2
        System.out.println("---업캐스팅 # 2---");
        char cast3 = 'b';
        ...
        int cast4 = 99; // # 1 방법
        int cast5 = 100; // # 2 방법
        // 지시 사항 : 다운 캐스팅하는 방법을 업캐스팅 # 1,2를 참조하여 char 형으로 바꾼 후
        // 콘솔 창에 원형과 변형을 모두 출력
        ...
        /*
            추후 수업에서 적용될 개념인데,
            upcasting의 경우 메모리 용량이 커지기만 하면 되니까 기존 데이터가 변형이 일어나지 않기 때문에 암시적(implicit)으로 변형이 가능한 반면,
